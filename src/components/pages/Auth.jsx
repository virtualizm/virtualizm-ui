        ...
        <Col xl={8} md={10} sm={15} xs={24}> 
          <Card className='login__wrapper'>
            <Row justify='center'>
              ...
              <Row gutter={20}>
                <Input placeholder="login" size='large' name="login" onChange={handleOnChange} />
                <div className='divider' />
                <Input.Password  placeholder="password" size='large' name="password" onChange={handleOnChange} />
                <div className='divider' />
                <Button 
                  type='primary' 
                  size='large' 
